...
export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-b from-white to-purple-50/30 border-t border-purple-500/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors">Press Kit</a></li>
